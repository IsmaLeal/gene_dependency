...
g_metrics = pd.read_csv('results/embeddings/g_embeddings_10d.csv')
hg_metrics = pd.read_csv('results/embeddings/HNHN_10d.csv')
...
df_g.to_csv('results/embeddings/g_10d_ml_performance_svc.csv', index=False)
...
df_hg.to_csv('results/embeddings/HNHN_10d_ml_performance_svc.csv', index=False)