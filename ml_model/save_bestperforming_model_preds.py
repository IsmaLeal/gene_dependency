...
hg_metrics = pd.read_csv('results/topological_metrics/hg_topological_metrics.csv')
...
results_hg, y_pred, y, genes, pathways = evaluate_models(X_hg, y_hg, models, 'Hypergraph')

np.savetxt('results/topological_metrics/y_pred_topol_hg.csv', y_pred, delimiter=',')
np.savetxt('results/topological_metrics/y_topol_hg.csv', y, delimiter=',')
np.savetxt('results/topological_metrics/genes_hg.csv', genes, delimiter=',')
np.savetxt('results/topological_metrics/pathways_hg.csv', pathways, delimiter=',', fmt='%s')
